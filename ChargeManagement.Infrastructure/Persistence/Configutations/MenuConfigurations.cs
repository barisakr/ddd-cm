...
namespace ChargeManagement.Infrastructure.Persistence.Configutations
{
    public class MenuConfigurations : IEntityTypeConfiguration<Menu>
    {
        ...
        {
            builder.OwnsMany(m => m.Sections, sbldr =>
            {
                sbldr.ToTable("MenuSections");

                sbldr.WithOwner().HasForeignKey("MenuId");

                sbldr.HasKey("Id", "MenuId");
                ...
                sbldr.Navigation(s => s.Items).Metadata.SetField("_items");
                sbldr.Navigation(s => s.Items).UsePropertyAccessMode(PropertyAccessMode.Field);
            });
